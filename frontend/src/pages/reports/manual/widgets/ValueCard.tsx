      ...
      {data.sensors.map((sensor, index) => (
        <Box
          ...
          sx={{
            ...
            px: 1,
            borderBottom:
              index !== data.sensors.length - 1 ? "1px solid #e0e7ff" : "none",
          }}
        >
          <Typography
            variant="body1"
        ...
        {data.aggregations.min && (
          <Box
            sx={{
              textAlign: "center",
              flex: 1,
              borderLeft: data.aggregations.max ? "1px solid #e0e7ff" : "none",
            }}
          >
            <Typography
              variant="caption"
        ...
        {data.aggregations.average && (
          <Box
            sx={{
              ...
              flex: 1,
              borderLeft:
                data.aggregations.max || data.aggregations.min
                  ? "1px solid #e0e7ff"
                  : "none",
            }}
          >
